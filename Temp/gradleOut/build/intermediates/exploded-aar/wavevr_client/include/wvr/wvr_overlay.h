...
/**
 * @param overlayId  which overlay should be control.
 * @param position.x Overlay's x relative to HMD.
 * @param position.y Overlay's y relative to HMD.
 * @param position.z Overlay's z relative to HMD.
...
/**
 * @param overlayId   which overlay should be control.
 * @param color.red    Red value between 0 and 1 to set.
 * @param color.green  Blue value between 0 and 1 to set.
 * @param color.blue   Green value between 0 and 1 to set.
...
/**
 * @param overlayId           which overlay should be control.
 * @param texture.textureId   Texture id which generated by user.
 * @param texture.width       Texture width which generated by user.
 * @param texture.height      Texture height which generated by user.
...
/**
 * @param callback.overlayId  which overlay should be control.
 * @param callback.cb         This callback will be called if a input event trigger.
 ...
 * @brief Overlay system will release after android suspend, so check WVR_IsOverlayValid per frame in native APP.
 * If WVR_IsOverlayValid return false, re-call WVR_GenOverlay to generate new overlay id.
 * @version API Level 2
 */
